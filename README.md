...
## What
Designed and built an autonomous robot capable of navigating the following map:
...
- Designed a **3D CAD model** for the chassis and sensor holders.  
- **Fabricated** the mechanical parts using **laser-cut MDF**.  
- Developed **Arduino code** that:
